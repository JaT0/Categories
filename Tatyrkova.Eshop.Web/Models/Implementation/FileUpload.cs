...
namespace Tatyrkova.Eshop.Web.Models.Implementation
{
    public class FileUpload
    {
        ...
        public FileUpload(string rootPath, string folderName, string contentType, long maxLengthFile = 10_000_000)
        {
