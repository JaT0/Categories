...
namespace Tatyrkova.Eshop.Web.Models.Validation
{
    ...
    public class ContentTypeAttribute : ValidationAttribute, IClientModelValidator
    {
        ...
        string ErrMess = "The file doesn't have the appropriate content!";
        ...
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            else if (value is IFormFile formFile)
            {
                ...
                return new ValidationResult(ErrMess, new List<string>() { validationContext.MemberName});
            }
        ...
        public void AddValidation(ClientModelValidationContext context)
        {
            ...
            context.Attributes.Add("data-val-filecontent", ErrMess);
